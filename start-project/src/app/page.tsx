...
function Page() {
  return (
    <div>
      ...
      <Person
        name="Pepe the Frog"
        avatar="https://media.discordapp.net/attachments/1184173326537588806/1204436140892094474/wine-wine-time.gif?ex=65d4b991&is=65c24491&hm=4e48c814b2442b35bca733e5647d85c3951cd7e466d797bee7b1631bc2e05bad&="
        misc={["@Pepe", "https://www.pepe.com"]}
      />
      <Person
        name="Doge"
